...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/WoncanHK/LiteSurveySDK-iOS"
  ...
  spec.source       = { :git => "https://github.com/WoncanHK/LiteSurveySDK-iOS.git", :tag => "#{spec.version}" }
